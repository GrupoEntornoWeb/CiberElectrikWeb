...
<html lang="es">
    ...
    <head>
        ...
        <title>CiberElectrik | Habilitar Categoria</title>
        ...
        <div class="container">
            ...
            <div class="card">
                <div class="card-header">
                    <h1>Habilitacion de Categorias</h1>
                </div>
                <div class="card-body">
                        ...
                        <table class="table table-striped table-hover table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><a href="CategoriaServlet?accion=habilitar&id=<%= cat.getCodigo()%>" class="btn btn-warning">Seleccionar</a></td>
                                    <td><a href="CategoriaServlet?accion=deshabilitar&id=<%= cat.getCodigo()%>"class="btn btn-danger">Seleccionar</a></td>
                                </tr>
                                <% }%>
                            </tbody>
                        </table>
