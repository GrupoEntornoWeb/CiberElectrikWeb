...
<html lang="es">
    <head>
        ...
        <title>CiberElectrik | Actualizar Categoria</title>
    ...
    <body>
        ...
        <div class="container">
            ...
            <form method="post" action="CategoriaServlet?accion=actualizar" accept-charset="UTF-8">
                <div class="col-6">
