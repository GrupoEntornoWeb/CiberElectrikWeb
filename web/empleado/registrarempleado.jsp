...
<head>
    ...
    <title>CiberElectrik | Registrar Empleado</title>
        ...
        <form>
            ...
            <div class="row">
                <div class="col-4">
                    ...
                    <select class="form-select" id="cboRol" name="cboRol" required>
            ...
            <a href="listarempleado.jsp" class="btn btn-dark">Regresar</a>
        </form>
    </div>
