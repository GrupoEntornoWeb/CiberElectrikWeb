...
<head>
    ...
    <title>CiberElectrik | Actualizar Tipo Documento</title>
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.8/dist/css/bootstrap.min.css" rel="stylesheet">
</head>
<body>
    <div class="container">
        <h1>Actualización de Tipo de Documento</h1>
        <form>
            <div class="col-6">
            ...
            <a href="listartipodocumento.jsp" class="btn btn-dark">Regresar</a>
        </form>
    </div>
